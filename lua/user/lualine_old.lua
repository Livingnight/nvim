...
-- vim.api.nvim_set_hl(0, "StatusLine", { fg = "#4d5566", bg = "#0d1117" })
-- -- vim.api.nvim_set_hl(0, "StatusLineSeparator", { fg = "#4d5566", bg = "NONE" })
...
-- vim.api.nvim_set_hl(0, "SLGitIcon", { fg = "#E8AB53", bg = black })
-- vim.api.nvim_set_hl(0, "SLTermIcon", { fg = purple, bg = black })
-- vim.api.nvim_set_hl(0, "SLBranchName", { fg = "#abb2bf", bg = black, bold = false })
...
-- vim.api.nvim_set_hl(0, "SLSeparator", { fg = "#6b727f", bg = black, italic = true })
-- vim.api.nvim_set_hl(0, "SLError", { fg = "#bf616a", bg = black })
-- vim.api.nvim_set_hl(0, "SLWarning", { fg = "#D7BA7D", bg = black })
...
--     return { fg = mode_color[vim.fn.mode()], bg = black }
--   end,
--   padding = 0,
-- }
