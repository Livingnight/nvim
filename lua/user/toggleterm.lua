...
function _G.set_terminal_keymaps()
  ...
  vim.api.nvim_buf_set_keymap(0, "t", "<s-m-h>", [[<C-\><C-n><C-W>h]], opts)
  vim.api.nvim_buf_set_keymap(0, "t", "<s-m-j>", [[<C-\><C-n><C-W>j]], opts)
  vim.api.nvim_buf_set_keymap(0, "t", "<s-m-k>", [[<C-\><C-n><C-W>k]], opts)
  vim.api.nvim_buf_set_keymap(0, "t", "<s-m-l>", [[<C-\><C-n><C-W>l]], opts)
end
...
local float_term = Terminal:new {
  ...
  on_open = function(term)
    ...
    vim.api.nvim_buf_set_keymap(term.bufnr, "", "<c-1>", "<nop>", { noremap = true, silent = true })
    vim.api.nvim_buf_set_keymap(term.bufnr, "", "<c-1>", "<nop>", { noremap = true, silent = true })
  end,
  count = 1,
}
